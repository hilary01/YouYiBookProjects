...
*/
    ...
    */
    _radioButton() {
        ...
        return <View style={{ flexDirection: 'row', alignItems: 'center', width: width - 80, height: 40 }}>
                ...
                <View style={styles.main_bg}>
                    ...
                    <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', marginLeft: 10 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <TextInput
                                style={{ width: width - 70, height: 40, backgroundColor: 'white', paddingTop: 13 }}
                    ...
                    <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', marginLeft: 10 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <TextInput
                                style={{ width: width - 90, height: 40, backgroundColor: 'white', paddingTop: 13 }}
                    ...
                    <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', marginLeft: 10 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <TextInput
                                style={{ width: width - 80, height: 40, backgroundColor: 'white', paddingTop: 13 }}
                    ...
                    <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', marginLeft: 10 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <Text style={{ width: width - 90, paddingTop: 15, paddingLeft: 5, paddingBottom: 8 }}>{this.state.registTime}</Text>
                            {/* <View style={{ justifyContent: 'flex-end', flexDirection: 'row', marginLeft: 10 }}>
                        <Image style={{ width: 14, height: 14, marginRight: 10 }} source={ICON_MORE} />
                    </View> */}
                        </View>
