            ...
            <View style={{ height: 140, justifyContent: 'center', marginTop: 1, backgroundColor: 'white' }}>
                <TouchableOpacity onPress={() => this.clickItem(itemData, index)} activeOpacity={0.8}>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <CachedImage style={{ height: 100, width: 80, marginLeft: 5 }} source={{ uri: itemData.item.book_icon }} />
                        <View style={{ height: 130, flexDirection: 'column', justifyContent: 'center', marginLeft: 10 }}>
                            ...
                            <Text style={styles.rule_item_time} numberOfLines={1}>出版社:{itemData.item.publisher_name}</Text>

                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 5 }}>
                                <TouchableOpacity activeOpacity={0.8} onPress={() => this._reduceGoods(itemData)}>
                                    <Image style={{ height: 34, width: 39, }} source={require('../img/btn_decrease.png')} />
                                </TouchableOpacity>
                                <View style={{ padding: 5, width: 60, borderWidth: 1, borderColor: '#e2e2e2', backgroundColor: 'white', alignItems: 'center', marginLeft: 5, marginRight: 5 }}>
    ...
    _renderData() {
        ...
        if (this.state.showNoData == true) {
            ...
            return <View style={{ alignItems: 'center' }}>
                <Image source={require('../img/shoppingcar_nodata_logo.png')} style={{ height: 150, width: 150, marginTop: 20 }} />
                <Text style={{ marginTop: 20 }}>购物车是空的，快去选购心爱的商品去吧！</Text>
                <TouchableOpacity activeOpacity={0.8} onPress={() => this._goBook()}>
                    <Image source={require('../img/btn_shoppingcar_nodata.png')} style={{ height: 40, width: 191, marginTop: 20 }} />
